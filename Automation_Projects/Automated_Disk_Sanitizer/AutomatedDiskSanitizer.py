...
def DeleteDuplicate(DirectoryName):
    ...
    fobj.write(Border + "\n")
    fobj.write("Duplicate File Automation Script\n")
    fobj.write(Border + "\n\n")
...
def main():
    ...
    print(Border)
    print("Duplicate File Automation Script")
    print(Border)
    ...
    if(len(sys.argv) == 2):
        ...
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("Usage :")
            print("python DuplicateFileAutomation.py DirectoryPath TimeInMinutes")
            print()
            print("Example :")
            print('python DuplicateFileAutomation.py "D:\\TestFolder" 5')
    ...
    print(Border)
    print("Thank you for using Duplicate File Automation Script")
    print(Border)
