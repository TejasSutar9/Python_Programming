...
def main():
    ...
    if(len(sys.argv) == 2):
        ...
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("Usage :")
            print("python PythonEmailAutomation.py SenderEmail AppPassword ReceiverEmail ReceiverName IntervalInMinutes")
...
"""
        ...
        # Schedule Email
        schedule.every(Interval).minutes.do(SendMail, SenderEmail, AppPassword, ReceiverEmail, Subject, Body)

        DisplayMessage(f"Python Email Automation Started. Email will be sent every {Interval} minute(s).","INFO")
